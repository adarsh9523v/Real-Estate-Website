    ...
    <>
      ...
      >
        <div className="flex flex-col justify-center items-start gap-5">
          ...
          <p className="text-slate-200 text-justify">
            ...
            adipisci consequatur aliquid maxime corporis quaerat quidem
            quibusdam accusamus aperiam rem.
          </p>
        ...
        <div className="flex flex-col justify-center items-start gap-5">
          ...
          <div className="flex justify-center items-center gap-3">
            ...
            <p className="text-slate-200">+984 3428 0399</p>
          </div>
          <div className="flex justify-center items-center gap-3">
            <FaFax className="text-white size-5" />
            <p className="text-slate-200">9595 45675</p>
          </div>
          <div className="flex justify-center items-center gap-3">
        ...
        <div className="flex flex-col justify-center items-start gap-5">
          ...
          <div className="flex justify-center items-center gap-4">
            ...
            <div>
              ...
              <p className="text-slate-400">$ 300</p>
            </div>
          </div>
          <div className="flex justify-center items-center gap-4">
            <img
      ...
      <div>
        <button
          ...
          className="flex items-centre p-4 rounded-full bg-orange-500 fixed lg:top-52 right-6 top-6"
        >
          {darkMode ? (
            <FaMoon size={15} className="text-black" />
          ) : (
            <FaSun size={15} className="text-black" />
          )}
        </button>
      </div>
    </>
