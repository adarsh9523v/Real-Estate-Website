    ...
    <>
      <div className={`${darkMode ? "dark bg-black" : "light bg-white"}`}> 
        ...
        >
          ...
          >
            ...
            deserunt ullam magni eum quaerat hic rerum magnam sed quasi
            voluptate?
          </p>
        </section>
      </div>
      ...
      >
        <div
          ...
          } lg:w-[70%] w-full m-auto grid lg:grid-cols-4 grid-cols-1 justify-centre items-centre gap-6 p-8 rounded-xl -mt-14`}
          data-aos="zoom-in"
          id="form"
        >
          ...
          <div className="w-full">
            <button className="bg-red-600 dark:bg-red-700 hover:bg-black dark:hover:bg-white dark:text-black text-lg p-4 w-full text-white font-semibold rounded-xl cursor-pointer transform hover:scale-110 transition-transform duration-300">
              SUBMIT
            </button>
          </div>
        </div>
