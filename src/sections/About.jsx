    ...
    >
      ...
      <div className="flex flex-col justify-center items-start gap-8">
        ...
        >
          ...
          in delectus beatae. Nihil ipsum, adipisci nesciunt natus similique
          provident expedita? Laborum cumque repellendus animi.
        </p>
        <button className="bg-red-600 dark:bg-red-700 hover:bg-black dark:hover:bg-white dark:text-black text-lg p-4 text-white font-semibold rounded-xl cursor-pointer transform hover:scale-110 transition-transform duration-300">
              READ MORE
            </button>
      </div>
    </section>
