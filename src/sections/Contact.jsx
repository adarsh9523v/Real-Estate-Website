      ...
      >
        ...
        <div className="flex flex-col justify-center items-start gap-8 lg:p-20 p-6">
          ...
          <p
            ...
            data-aos-delay="500"
            className="
          text-xl text-gray-600 text-justify dark:text-white"
          >
            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Maiores,
            eligendi? Culpa ut, labore quia magnam eligendi voluptatum ex beatae
            commodi vero doloremque? Porro placeat magnam, dolorum officiis
            sapiente quisquam quod.
          </p>
